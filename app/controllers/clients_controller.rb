class ClientsController < ApplicationController
  ...
  # GET /clients/1.json
  def show
    @phones = ClientPhone.where(client_id: params[:id])
    @current_accounts = ClientCurrentAccount.where(client_id: params[:id])
  end
  ...
  private
    ...
    def client_params
      params.require(:client).permit(:cod, :name, :last_name, :address, :job_address, :obs)
    end
end
